...
namespace Mooege.Core.MooNet.Toons
{
    public class Toon : PersistentRPCObject
    {
        ...
        public IntPresenceField HeroFlagsField
        {
            get
            {
                var val = new IntPresenceField(FieldKeyHelper.Program.D3, FieldKeyHelper.OriginatingClass.Hero, 4, 0, (int)this.DBToon.Flags + Convert.ToUInt16(DBToon.isHardcore)); // Hardcore mode add +1 to flags [Necrosummon]
                return val;
            }
        }
        ...
        */
        ...
        {
            get { return this.DBToon.isHardcore; }
            set { this.DBToon.isHardcore = value; }
        }
        ...
        public D3.Hero.Digest Digest
        {
            get
            {
                return D3.Hero.Digest.CreateBuilder().SetVersion(902)
                                ...
                                .SetPlayerFlags((uint)this.Flags + Convert.ToUInt16(isHardcore)) // If is hardcore character, add +1 to Flags. [Necrosummon]
                                .SetLevel(this.Level)
